...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        public void StartNewGame(PlayerType whiteType, PlayerType blackType)
        {
            ...
            //board.LoadPosition("bqqnkqbn/pppppnbp/8/8/8/8/NBBBNBBP/NNQNKRBQ w - - 0 1");
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.V10 => new ChessPlayer(new Jazz10(), type, GameDurationMilliseconds),
                PlayerType.V11 => new ChessPlayer(new Jazz11(), type, GameDurationMilliseconds),
                PlayerType.V12 => new ChessPlayer(new Jazz12(), type, GameDurationMilliseconds),
                PlayerType.V13 => new ChessPlayer(new Jazz13(), type, GameDurationMilliseconds),
        ...
        public static ChessChallenge.API.IChessBot? CreateBot(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.V10 => new Jazz10(),
                PlayerType.V11 => new Jazz11(),
                PlayerType.V12 => new Jazz12(),
                PlayerType.V13 => new Jazz13(),
