...
public class Jazz13 : IChessBot //jazz 1.3
{
    ...
    public int getEval(Board board, bool Iswhite)
    {
        ...
        for(int i = 0;i<pieceslist.Length;i++)
        {
            ...
            if (i < pieceslist.Length / 2)
            {
                ...
                {
                    eval += pieceValues[tableIndex[pieceslist[i].TypeOfPieceInList.ToString()]] + pieceTables[tableIndex[pieceslist[i].TypeOfPieceInList.ToString()]][currentPiece[j].Square.Index];
                }
            }
            else
            {
                ...
                for (int j = 0; j < currentPiece.Count; j++)
                {
                    eval -= pieceValues[tableIndex[pieceslist[i].TypeOfPieceInList.ToString()]] + pieceTables[tableIndex[pieceslist[i].TypeOfPieceInList.ToString()]][63-currentPiece[j].Square.Index];
                }
            }
        }
        if(Iswhite) 
    ...
    {        
        ...
        /*int depth = 6;
        if (timer.MillisecondsRemaining > 55000 | timer.MillisecondsRemaining < 30000)
        {
            depth = 5;
        }
